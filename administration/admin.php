...
<body>
    <main class="content">
        <div>
            <p>Veuillez rentrer vos identifiants Administrateur, Sinon retourner a la page de <a
                    href="../login.php">connection</a></p>
        </div>
        <form method="post">
...
?>
                <div class="champ-texte">
                    <input type="text" class="champtxt" name="user_name" id="usernames" placeholder="Ex: Doe_2022"
                        required />
